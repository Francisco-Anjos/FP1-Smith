...
inventory = [Chestplate(20), Helmet(10), Boots(10), Gem(8), Sword(3), Hammer(2), Bow(3, 2), item("Trash", 2), BronzeChestplate(15), BronzeHelmet(8), BronzeGem(8),WorthySword(16),BrawlerHammer(14),SeekersBow(12)]
