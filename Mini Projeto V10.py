...
inventory = [Chestplate(), Helmet(), Boots(), Gem(), Sword(3), Hammer(2), Bow(3, 2), item("Trash", 2), BronzeChestplate(), BronzeHelmet(), BronzeBoots()]
    ...
    while(player.gold >= 0):  
        ...
        if PlayerChoice == "3":
            ...
            #Craft Armor           
                ...
                #Craft all 3 Bronze Armor Pieces
                elif PlayerChoiceCraftArmor == "Bronze Armor":
                    if  materials[4, 2].resourceamount >= 2:
                        materials[4, 2].resourceamount -= 2
                        inventory[8, 9, 10].ArmorAmount += 1
                        print("Forging...")
                        player.self_xp += 15
                        time.sleep(0.5)
                    else:
