...
while(command != "Quit" or "Exit"):
    while(player_gold > 0):  
        ...
        if PlayerChoice == "2":
            ...
            if input() == "Wood":
                player_gold = player_gold - 2
                ResourceAmount = ResourceAmount + (1, 0, 0)
                ...
                player_gold = player_gold - 3
                ResourceAmount = ResourceAmount + (0, 0, 1)
                print("Processing payment...")
                time.sleep(1)      
        if PlayerChoice == "3":
            print("-Sword- = 1 Wood, 1 Iron.\n-Armor- = 2 leather 2 Iron.\n-Gem- = 1 Iron.")
            if input() == "Sword":
                if ResourceAmount >= (1, 1, 0):
                ...
                if ResourceAmount >= (0, 2, 2):
                    ResourceAmount = ResourceAmount - (0, 2, 2)
                    ArmorAmount = ArmorAmount + 1
                    print("Forging...")
                    time.sleep(0.5)
                else:
                    print("Not enough resources")
