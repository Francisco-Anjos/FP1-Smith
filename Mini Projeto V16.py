...
class WorthySword(item):
    damage = 0
    def __init__(self, damage):
        super().__init__("WorthySword", 1)
        self.damage = damage
        
    def display(self):
        super().display()
        print("Damage " + str(self.damage))
        print("A true warriors weapon, fit for cutting.")
#GemClass(price)
class Gem(item):
    def __init__(self):
...
#SeekersClass(damage,accuracy,sell price)
class SeekersBow(item):
    def __init__(self, damage, accuracy):
        super().__init__("SeekersBow", 3)
        self.damage = damage
        self.accuracy = accuracy
...
#HammerClass(damage,sell)        
class BrawlerHammer(item):
    def __init__(self, damage):
       super().__init__("BrawlerHammer", 3)
       self.damage = damage
        
    def display(self):
        super().display()
        print("Damage " + str(self.damage))
        print("A weapon used by barbarians.")
...
inventory = [Chestplate(), Helmet(), Boots(), Gem(), Sword(3), Hammer(2), Bow(3, 2), item("Trash", 2), BronzeChestplate(), BronzeHelmet(), BronzeGem(),WorthySword(16),BrawlerHammer(14),SeekersBow(12,50)]
...
while(command != "Quit" or "Exit"):
    while(player.gold >= 0):  
        ...
        if PlayerChoice == "Inventory":
            ...
            print("Worthy Sword: " + str(WSwordAmmount))
            print("Brawler Hammer: " + str(BHammerAmmount))
            print("Seeker's Bow: " + str(SBowAmmount))
        ...
        if PlayerChoice == "1":
            ...
            if player.player_level >= 3:
                print("Sell 1 -WSword- for 18 gold\nSell 1 -BHammer- for 15 gold\nSell 1 -SBow- for 15 gold")
            PlayerChoice2 = input()
            ...
            if PlayerChoice2 == "SBow":
                if SBowAmmount >=1:
                    ...
                    print("You don't have any SeekersBow.")
        ...
        if PlayerChoice == "3":
            ...
            #Crafting for level 3 Player
            if player.player_level >= 3:
                print("Crafting a -WSword- = 2 Leather 2 Iron 2 Wood.\nCrafting a -BHammer- = 2 Wood 1 Iron 2 Leather.\nCrafting a -SBow- = 2 Wood 6 String 1 Leather")
            PlayerChoice4 = input()
            #Craft Sword
            ...
            #Craft WorthySword
            if PlayerChoice4 == "WSword":
                if player.player_level >= 3:
                    if  materials[0].resourceamount >= 2:
                        if  materials[1].resourceamount >= 2:
                            if materials[2].resourceamount >=2:
                                print("Forging...")
                                player.self_xp += 6
                    ...
                    print("Looking through code huh...")         
            ...
            if PlayerChoice4 == "Bow":
                if materials[0].resourceamount >= 2:
                    ...
                    print("Not enough Wood")
            #Craft SeekersBow
            if PlayerChoice4 == "SBow":
                if player.player_level >= 3:
                    if materials[0].resourceamount >= 2:
                        if materials[3].resourceamount >= 6:
